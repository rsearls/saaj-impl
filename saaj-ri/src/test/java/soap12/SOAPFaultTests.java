...
public class SOAPFaultTests extends TestCase {
    ...
    public void testSetFaultReasonText() throws Exception {
        ...
        Iterator<Node> faultElements = fault.getChildElements();
    ...
    public void testAppendFaultSubcode() throws Exception {
        ...
        Iterator<Node> eachCodeChild = code.getChildElements();
        eachCodeChild.next();
        SOAPElement subcode = (SOAPElement) eachCodeChild.next();

        Iterator<Node> eachSubcodeChild = subcode.getChildElements();
        ...
        Iterator<Node> eachSubSubcodeChild = subSubcode.getChildElements();
    ...
    public void testOrderOfFaultElements() throws Exception {
        ...
        Iterator<Node> it = sf.getChildElements();
