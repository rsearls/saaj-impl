...
public class ElementTest extends TestCase {
    ...
    public void testAddChildElement() throws Exception {
        ...
        Iterator<jakarta.xml.soap.Node> eachChild =
    ...
    public void testAddHeaderElement() throws Exception {
        ...
        Iterator<jakarta.xml.soap.Node> eachHeader = header.getChildElements();
        ...
        Iterator<jakarta.xml.soap.Node> eachChild = headerElement.getChildElements();
    ...
    public void testAddBodyElement() throws Exception {
        ...
        Iterator<jakarta.xml.soap.Node> eachBodyElement = body.getChildElements();
        ...
        Iterator<jakarta.xml.soap.Node> eachChild = bodyElement.getChildElements();
    ...
    public void testDetachChildElements() throws Exception {
        ...
        SOAPElement child;
        Iterator<jakarta.xml.soap.Node> eachChild = element.getChildElements();
