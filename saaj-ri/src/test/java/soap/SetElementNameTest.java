...
public class SetElementNameTest extends TestCase {
	...
	private void createMessageTwo() throws Exception {
		...
		Iterator<Node> soapBodyElements = body.getChildElements();
	...
	public void testSetElementNameWithFault() throws Exception {
		...
		Iterator<Node> eachChild = fault.getChildElements();
		...
		Iterator<Node> children = newFirstEntry.getChildElements();
