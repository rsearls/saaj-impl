...
<<<<<<< HEAD:saaj-ri/src/test/bugfixes/BugfixesTest.java
*/      
...
>>>>>>> ec448be... updated to jakarta. Merged current metro-saaj into here:saaj-ri/src/test/java/bugfixes/BugfixesTest.java
    ...
    public void testReadMultipleLines() throws Exception {
        ...
        Iterator<Node> eachChild = body.getChildElements();
        eachChild.next();
...
//    }
    ...
    public void testSetContentDOMSrc() throws Exception {
        ...
        try {
            msg.writeTo(new FileOutputStream("src/test/resources/bugfixes/data/tempFile"));
        } catch(Exception e) {
            e.printStackTrace();
    ...
    public void testFaultUnqualifiedSubElements() throws Exception {
        ...
        Iterator<Node> faultChildren = sf.getChildElements();
    ...
    public void testAddChildElementTest5() throws Exception {
        ...
        if (se == null) {
            ...
            Iterator<Node> i = body.getChildElements(name);
            int count = 0;
            while (i.hasNext()) {
                count++;
                i.next();
    ...
    public void testAddDocument() throws Exception {
        ...
        Iterator<Node> iter1 = body.getChildElements();
    ...
    private void getContents(
        ...
        while (iterator.hasNext()) {
            ...
            if (node instanceof SOAPElement) {
                ...
                Iterator<Node> iter2 = element.getChildElements();
    ...
    public void testExamineHeaderElements() throws Exception {
        ...
        FileOutputStream sentFile = new FileOutputStream(
            "src/test/resources/bugfixes/data/examine.xml");
        ...
        Iterator<Node> it = recvHdr.getChildElements();
...
//System.out.println("Endorsed="+System.getProperty("java.endorsed.dirs"));
    ...
    public static void testSAAJIssue39() throws SOAPException, IOException {
        ...
        m.saveChanges();
        AttachmentPart ap = m.createAttachmentPart(new DataHandler(new FileDataSource("src/test/resources/mime/data/java.gif")));
